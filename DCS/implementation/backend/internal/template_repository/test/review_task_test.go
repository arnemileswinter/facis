...
func TestSubmit_CreateReviewTasksAndApproveThem(t *testing.T) {
	...
	for _, assignee := range assignees {
		err := template_repository.UpdateReviewTask(ctx, tx, *did, 1, 1, assignee, review_task_state.Approved, []string{"Test 1", "Test 2"})
		if err != nil {
...
func TestSubmit_CreateReviewTasksAndCancelThem(t *testing.T) {
