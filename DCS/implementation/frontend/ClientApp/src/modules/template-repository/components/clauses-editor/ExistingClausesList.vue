    ...
    <div v-for="clause in clauseBlocks" :key="clause.blockId"
      ...
      <div class="flex-1 min-w-0">
        <div v-if="editingBlockId === clause.blockId">
          <ClauseEditorForm :mode="'edit'" :initial-title="clause.title ?? ''" :initial-text="clause.text ?? ''"
      ...
      <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0"
        ...
        <button type="button" class="btn btn-ghost btn-xs text-error" aria-label="Delete clause"
