        ...
        <div class="sticky top-0 z-10 shrink-0 bg-base-200 border-b border-base-300">
            <div class="max-w-4xl mx-auto px-6 pt-3">
                ...
                <div role="tablist" class="tabs tabs-lift tabs-lg">
                    <a role="tab" class="tab" :class="{ 'tab-active': activeTab === 'details' }"
                        @click="activeTab = 'details'">Details</a>
                    <a role="tab" class="tab" :class="{ 'tab-active': activeTab === 'semantic' }"
                        @click="activeTab = 'semantic'">Semantic Rules</a>
                    <a role="tab" class="tab" :class="{ 'tab-active': activeTab === 'clauses' }"
                        @click="activeTab = 'clauses'">Clauses</a>
                    <a role="tab" class="tab" :class="{ 'tab-active': activeTab === 'builder' }"
                        @click="activeTab = 'builder'">Builder</a>
                    <a role="tab" class="tab" :class="{ 'tab-active': activeTab === 'meta' }"
                        @click="activeTab = 'meta'">Meta Data</a>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body gap-5">
                                ...
                                <fieldset class="fieldset p-0 border-none">
                                    ...
                                    <div class="grid grid-cols-2 gap-3 mt-1">
                                        <label class="card border-2 cursor-pointer transition-all" :class="form.contract_kind === 'frame_contract'
                                        ...
                                        <label class="card border-2 cursor-pointer transition-all" :class="form.contract_kind === 'subcontract'
                                            ? 'border-primary bg-primary/5'
                                            : 'border-base-300 hover:border-base-content/20'">
